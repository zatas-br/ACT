  ...
  pt: {
    ...
    home: {
        ...
        items: [
          ...
          },
          {
            ...
            list: [
              ...
              "amadurecimento da cultura e dos líderes;",
          ...
          },
          {
            ...
            footer: "Para ambientes residenciais e corporativos, incluímos serviços especializados de organização de espaços, home offices e rotinas funcionais.<br><br>Nosso foco: processos inteligentes, pessoas qualificadas e experiência impecável para os hóspedes."
          },
          {
            image: "img/servicos/4.png",
            title: "5. Valuation – Comprar ou Vender sua Empresa",
            shortDescription: "A ACT conduz processos completos de estruturação, expansão e valuation.",
            description: "A ACT conduz processos completos de estruturação, expansão e valuation.<br><br>Trabalhamos em três etapas:<br><strong>1. Organização completa do negócio</strong> — processos, finanças, governança, áreas internas, indicadores e estrutura.<br><strong>2. Expansão estratégica</strong> — modelo franqueável, investidores, novas unidades ou reestruturação.<br><strong>3. Valuation e processo de venda</strong> — construção e análise minuciosa pelo FCD (Fluxo de Caixa Descontado), estudo de mercado, preparação para negociação e prospecção qualificada.<br><br>O valuation serve para:",
            list: [
              "medir o valor real da empresa;",
              "orientar decisões futuras;",
              "preparar sucessores;",
              "facilitar venda ou entrada de sócios;",
              "identificar riscos e potenciais ocultos."
            ],
          ...
          },
          {
            ...
            list: [
              "governança condominial e residencial;",
              "planejamento orçamentário transparente;",
              "processos para segurança, manutenção e convivência;",
              "cursos e treinamentos para síndicos, líderes e gestores;",
              "implantação de práticas sustentáveis e ESG aplicadas ao dia a dia comunitário."
            ],
            footer: "Acreditamos que comunidades bem geridas elevam o padrão de vida, valorizam monetariamente os imóveis e espaços dos investidores e proprietários(as), e fortalecem o tecido social das cidades."
          },
          {
            image: "img/servicos/6.png",
            title: "7. Projetos Socioculturais",
            shortDescription: "A ACT desenvolve projetos que fortalecem a cidadania, a cultura, a arte e a convivência, utilizando como ferramentas a música, a dança, o teatro, a poesia e o cinema.",
            description: "A ACT desenvolve projetos que fortalecem a cidadania, a cultura, a arte e a convivência, utilizando como ferramentas a música, a dança, o teatro, a poesia e o cinema. Atua no desenvolvimento de comunidades — social e empresarial — mais saudáveis, por meio de oficinas para crianças, jovens e adultos, além de projetos de identidade e pertencimento.<br><br>A ACT traz em sua trajetória, experiências consideráveis nas avaliações e análises de projetos culturais, com atuações em curadorias, seleções e contratações de atividades artísticas, considerando critérios de mérito cultural, viabilidade técnica, aderência ao público e impacto sociocultural.<br><br>A dança, por exemplo, é aplicada como instrumento de integração, formação de lideranças, valorização da diversidade cultural, inclusão social e estímulo ao empreendedorismo.<br><br>Cientificamente, estudos da neurociência e da saúde mental comprovam que a arte, em especial a Dança Social, promove a neuroplasticidade e aprimora a cognição. Essa prática configura um caminho para o amadurecimento humano e coletivo, ao promover saúde física, mental e social, combater o sedentarismo e contribuir para a criação de ambientes mais equilibrados, saudáveis e produtivos.<br><br>Tais resultados estão em consonância com os princípios contemporâneos de bem-estar, prevenção e gestão de riscos ocupacionais, alinhando-se, inclusive, às diretrizes da NR-1.",
            list: [],
            footer: "Por meio dessas práticas, a ACT estimula o autoconhecimento, a convivência harmoniosa e a transformação positiva dos territórios."
          }
        ]
      },
      segments: {
      ...
      expertises: {
        ...
        paragraphs: [
          "Desde 2009, a ACT constrói uma trajetória que integra gestão, cultura, inovação e desenvolvimento humano, sempre atenta à realidade concreta de cada organização. Iniciou sua atuação desenvolvendo soluções para empresas e instituições de serviços, comércio e pequenas indústrias, o que permitiu uma compreensão ampla do ecossistema econômico. Ao longo do tempo, aprofundou seu trabalho com empresas familiares, projetos culturais e organizações do terceiro setor, apoiando negócios em busca de clareza de propósito, organização e futuro.",
          "Com o amadurecimento da atuação, a ACT ampliou sua presença na profissionalização de empresas de pequeno e médio porte, conduzindo processos sensíveis como governança, sucessão e estruturação da gestão. Aplica ferramentas tradicionalmente associadas a grandes organizações — como processos seletivos estruturados, conselhos consultivos, NR-1, indicadores de desempenho, valuation e planejamento financeiro — sempre adaptadas, validadas e viáveis à escala de cada negócio.",
          "Nas últimas décadas, com forte conexão com a criatividade e a inovação, a ACT passou a atuar ativamente em ecossistemas de empreendedorismo, participando e mentorando startup weekends, hackathons e programas vinculados ao INPI e à FAPESP. Vivências internacionais em países como México, Estados Unidos, Argentina, Espanha, França, Uruguai e Portugal reforçaram essa visão global, aplicada de forma prática à realidade brasileira e integrada a temas contemporâneos como ESG, Agenda 2030, inteligência estratégica, inteligência artificial e novas economias."
        ],
        items: [
          { 
            image: "img/expertises/1.png", 
            title: "INDÚSTRIAS", 
            description: "A ACT atua de forma estratégica na organização, desenvolvimento e expansão de operações industriais e comerciais, apoiando empresas que buscam eficiência, controle, crescimento sustentável e proteção do patrimônio construído ao longo dos anos.<br><br>Nossa experiência inclui atuação direta nas seguintes demandas:", 
            list: [
              "Indústrias metalúrgicas;",
              "Indústrias termoformagem;",
              "Indústrias alimentícias;",
              "Indústrias de bicicletas;",
              "Indústrias de vestuários."
            ],
            footer: "Realizamos diagnósticos precisos, reestruturação de processos, organização financeira, melhoria da gestão de pessoas e apoio à tomada de decisão estratégica.<br><br>Em ambientes produtivos e competitivos, a ACT trabalha para reduzir desperdícios, otimizar recursos, estruturar lideranças, profissionalizar rotinas e preparar a empresa para novos ciclos de crescimento, investimentos ou sucessão. Mais do que conceitos, entregamos método, clareza e resultados aplicáveis à realidade de cada operação."
          },
          { 
            image: "img/expertises/2.png", 
            title: "VAREJOS & COMÉRCIOS", 
            description: "A ACT atua na organização, profissionalização e expansão de negócios varejistas que nasceram da prática, do esforço diário e da visão empreendedora de seus fundadores. Nosso trabalho é transformar operações “tocadas no dia a dia” em empresas organizadas, controladas e preparadas para crescer com segurança.<br><br>Atuamos desde a organização financeira e operacional, passando por processos de compras, precificação, gestão de pessoas, definição de regras internas, indicadores de desempenho, até o planejamento de expansão, sucessão familiar ou valorização do negócio para futuras decisões estratégicas.<br><br>A ACT já desenvolveu projetos e entregou resultados em diversos formatos de varejo, incluindo:", 
            list: [
              "Supermercados;",
              "Bares;",
              "Pizzarias;",
          ...
          { 
            ...
            list: [
              ...
              "Administração de Imóveis e Propriedades;",
              "Lojas de Assistência Técnica;",
              "Academias (Gym)."
            ],
            footer: "Em todos esses contextos, a ACT atua com proximidade, método e visão estratégica, contratando e organizando equipes, processos e finanças para reduzir conflitos, aumentar eficiência, melhorar a entrega ao cliente e proteger o patrimônio do empreendedor. Nosso foco é transformar prestação de serviços em negócio organizado, valorizado e preparado para o futuro."
          },
          { 
            ...
            list: [
              ...
              "Instituições de Saúde Física e Mental;",
              "Instituições de Inovação e Empreendedorismo;",
              "Instituições Públicas."
            ],
            footer: "Em todos esses contextos, a ACT atua com responsabilidade técnica, sensibilidade humana e visão estratégica, ajudando organizações a estruturar sua gestão, otimizar recursos, fortalecer sua missão e ampliar seu impacto social de forma ética, organizada e sustentável ao longo do tempo."
          }
        ]
      },
      testimonials: {
        ...
        items: [
          {
            image: "img/Depoimentos/educação-de-qualidade.jpeg",
          ...
          {
            image: "img/Depoimentos/parati-residencial.jpeg",
          ...
          {
            image: "img/Depoimentos/facig.jpeg",
          ...
          {
            image: "img/Depoimentos/solucao-acessosoria-e-planejamento.jpeg",
          ...
          {
            image: "img/Depoimentos/grupo-augustus.jpeg",
          ...
          {
            image: "img/Depoimentos/sao-carlos.jpeg",
          ...
          {
            image: "img/Depoimentos/vacuum-solutions.jpeg",
          ...
          {
            image: "img/Depoimentos/bejo.jpeg",
          ...
          {
            image: "img/Depoimentos/usinovapar.jpeg",
          ...
          {
            image: "img/Depoimentos/palazzo-residencial.jpeg",
          ...
          {
            image: "img/Depoimentos/emporio-gourmet.jpeg",
    ...
    about: {
      history: {
        ...
        cards: [
          ...
          },
          {
            ...
            icon: '<svg viewBox="0 0 24 24"><path d="M16 18l2.29-2.29-4.88-4.88-4 4L2 7.41 3.41 6l6 6 4-4 6.3 6.29L22 12v6z"/></svg>'
          },
          {
      ...
      mission: {
        ...
        valuesList: [
          ...
          "Sustentabilidade Real — decisões que preservam o futuro."
        ]
      }
    },
    contact: {
